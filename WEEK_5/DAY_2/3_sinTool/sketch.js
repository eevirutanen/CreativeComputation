//Sine Editor
//Eevi Rutanen
//This example demonstrates how to create a graphical user interface using sliders and a selection box.
//It also demonstrates how to add CSS class selectors to elements and style them with CSS.
//Add more sliders and selection options, or other elements like buttons, radio buttons, color picker tools and checkboxes!
